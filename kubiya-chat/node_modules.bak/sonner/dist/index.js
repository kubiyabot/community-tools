...
`);function et(s){return s.label!==void 0}var ve=3,Te="32px",Se="16px",Kt=4e3,Re=356,Ee=14,De=20,Pe=200;function I(...s){return s.filter(Boolean).join(" ")}function Ne(s){let[e,t]=s.split("-"),a=[];return e&&a.push(e),t&&a.push(t),a}var Be=s=>{var Nt,Bt,Ct,kt,It,Mt,Ht,At,Lt,zt,jt;let{invert:e,toast:t,unstyled:a,interacting:l,setHeights:f,visibleToasts:w,heights:R,index:g,toasts:i,expanded:D,removeToast:T,defaultRichColors:F,closeButton:ot,style:mt,cancelButtonStyle:gt,actionButtonStyle:c,className:at="",descriptionClassName:st="",duration:K,position:rt,gap:ht,loadingIcon:nt,expandByDefault:B,classNames:r,icons:P,closeButtonAriaLabel:it="Close toast",pauseWhenPageIsHidden:lt}=s,[j,M]=o.default.useState(null),[ct,X]=o.default.useState(null),[W,H]=o.default.useState(!1),[A,bt]=o.default.useState(!1),[L,Y]=o.default.useState(!1),[dt,u]=o.default.useState(!1),[h,y]=o.default.useState(!1),[E,z]=o.default.useState(0),[p,_]=o.default.useState(0),O=o.default.useRef(t.duration||K||Kt),J=o.default.useRef(null),C=o.default.useRef(null),Jt=g===0,Gt=g+1<=w,N=t.type,V=t.dismissible!==!1,Qt=t.className||"",qt=t.descriptionClassName||"",ut=o.default.useMemo(()=>R.findIndex(n=>n.toastId===t.id)||0,[R,t.id]),Zt=o.default.useMemo(()=>{var n;return(n=t.closeButton)!=null?n:ot},[t.closeButton,ot]),Rt=o.default.useMemo(()=>t.duration||K||Kt,[t.duration,K]),yt=o.default.useRef(0),U=o.default.useRef(0),Et=o.default.useRef(0),G=o.default.useRef(null),[te,ee]=rt.split("-"),Dt=o.default.useMemo(()=>R.reduce((n,m,d)=>d>=ut?n:n+m.height,0),[R,ut]),Pt=_t(),oe=t.invert||e,wt=N==="loading";U.current=o.default.useMemo(()=>ut*ht+Dt,[ut,Dt]),o.default.useEffect(()=>{O.current=Rt},[Rt]),o.default.useEffect(()=>{H(!0)},[]),o.default.useEffect(()=>{let n=C.current;if(n){let m=n.getBoundingClientRect().height;return _(m),f(d=>[{toastId:t.id,height:m,position:t.position},...d]),()=>f(d=>d.filter(b=>b.toastId!==t.id))}},[f,t.id]),o.default.useLayoutEffect(()=>{if(!W)return;let n=C.current,m=n.style.height;n.style.height="auto";let d=n.getBoundingClientRect().height;n.style.height=m,_(d),f(b=>b.find(x=>x.toastId===t.id)?b.map(x=>x.toastId===t.id?{...x,height:d}:x):[{toastId:t.id,height:d,position:t.position},...b])},[W,t.title,t.description,f,t.id]);let $=o.default.useCallback(()=>{bt(!0),z(U.current),f(n=>n.filter(m=>m.toastId!==t.id)),setTimeout(()=>{T(t)},Pe)},[t,T,f,U]);o.default.useEffect(()=>{if(t.promise&&N==="loading"||t.duration===1/0||t.type==="loading")return;let n;return D||l||lt&&Pt?(()=>{if(Et.current<yt.current){let b=new Date().getTime()-yt.current;O.current=O.current-b}Et.current=new Date().getTime()})():(()=>{O.current!==1/0&&(yt.current=new Date().getTime(),n=setTimeout(()=>{var b;(b=t.onAutoClose)==null||b.call(t,t),$()},O.current))})(),()=>clearTimeout(n)},[D,l,t,N,lt,Pt,$]),o.default.useEffect(()=>{t.delete&&$()},[$,t.delete]);function ae(){var n,m,d;return P!=null&&P.loading?o.default.createElement("div",{className:I(r==null?void 0:r.loader,(n=t==null?void 0:t.classNames)==null?void 0:n.loader,"sonner-loader"),"data-visible":N==="loading"},P.loading):nt?o.default.createElement("div",{className:I(r==null?void 0:r.loader,(m=t==null?void 0:t.classNames)==null?void 0:m.loader,"sonner-loader"),"data-visible":N==="loading"},nt):o.default.createElement(Ft,{className:I(r==null?void 0:r.loader,(d=t==null?void 0:t.classNames)==null?void 0:d.loader),visible:N==="loading"})}return o.default.createElement("li",{tabIndex:0,ref:C,className:I(at,Qt,r==null?void 0:r.toast,(Nt=t==null?void 0:t.classNames)==null?void 0:Nt.toast,r==null?void 0:r.default,r==null?void 0:r[N],(Bt=t==null?void 0:t.classNames)==null?void 0:Bt[N]),"data-sonner-toast":"","data-rich-colors":(Ct=t.richColors)!=null?Ct:F,"data-styled":!(t.jsx||t.unstyled||a),"data-mounted":W,"data-promise":!!t.promise,"data-swiped":h,"data-removed":A,"data-visible":Gt,"data-y-position":te,"data-x-position":ee,"data-index":g,"data-front":Jt,"data-swiping":L,"data-dismissible":V,"data-type":N,"data-invert":oe,"data-swipe-out":dt,"data-swipe-direction":ct,"data-expanded":!!(D||B&&W),style:{"--index":g,"--toasts-before":g,"--z-index":i.length-g,"--offset":`${A?E:U.current}px`,"--initial-height":B?"auto":`${p}px`,...mt,...t.style},onPointerDown:n=>{wt||!V||(J.current=new Date,z(U.current),n.target.setPointerCapture(n.pointerId),n.target.tagName!=="BUTTON"&&(Y(!0),G.current={x:n.clientX,y:n.clientY}))},onPointerUp:()=>{var x,Q,q,Z;if(dt||!V)return;G.current=null;let n=Number(((x=C.current)==null?void 0:x.style.getPropertyValue("--swipe-amount-x").replace("px",""))||0),m=Number(((Q=C.current)==null?void 0:Q.style.getPropertyValue("--swipe-amount-y").replace("px",""))||0),d=new Date().getTime()-((q=J.current)==null?void 0:q.getTime()),b=j==="x"?n:m,k=Math.abs(b)/d;if(Math.abs(b)>=De||k>.11){z(U.current),(Z=t.onDismiss)==null||Z.call(t,t),X(j==="x"?n>0?"right":"left":m>0?"down":"up"),$(),u(!0),y(!1);return}Y(!1),M(null)},onPointerMove:n=>{var Q,q,Z,Yt;if(!G.current||!V||((Q=window.getSelection())==null?void 0:Q.toString().length)>0)return;let d=n.clientY-G.current.y,b=n.clientX-G.current.x,k=(q=s.swipeDirections)!=null?q:Ne(rt);!j&&(Math.abs(b)>1||Math.abs(d)>1)&&M(Math.abs(b)>Math.abs(d)?"x":"y");let x={x:0,y:0};j==="y"?(k.includes("top")||k.includes("bottom"))&&(k.includes("top")&&d<0||k.includes("bottom")&&d>0)&&(x.y=d):j==="x"&&(k.includes("left")||k.includes("right"))&&(k.includes("left")&&b<0||k.includes("right")&&b>0)&&(x.x=b),(Math.abs(x.x)>0||Math.abs(x.y)>0)&&y(!0),(Z=C.current)==null||Z.style.setProperty("--swipe-amount-x",`${x.x}px`),(Yt=C.current)==null||Yt.style.setProperty("--swipe-amount-y",`${x.y}px`)}},Zt&&!t.jsx?o.default.createElement("button",{"aria-label":it,"data-disabled":wt,"data-close-button":!0,onClick:wt||!V?()=>{}:()=>{var n;$(),(n=t.onDismiss)==null||n.call(t,t)},className:I(r==null?void 0:r.closeButton,(kt=t==null?void 0:t.classNames)==null?void 0:kt.closeButton)},(It=P==null?void 0:P.close)!=null?It:Wt):null,t.jsx||(0,o.isValidElement)(t.title)?t.jsx?t.jsx:typeof t.title=="function"?t.title():t.title:o.default.createElement(o.default.Fragment,null,N||t.icon||t.promise?o.default.createElement("div",{"data-icon":"",className:I(r==null?void 0:r.icon,(Mt=t==null?void 0:t.classNames)==null?void 0:Mt.icon)},t.promise||t.type==="loading"&&!t.icon?t.icon||ae():null,t.type!=="loading"?t.icon||(P==null?void 0:P[N])||$t(N):null):null,o.default.createElement("div",{"data-content":"",className:I(r==null?void 0:r.content,(Ht=t==null?void 0:t.classNames)==null?void 0:Ht.content)},o.default.createElement("div",{"data-title":"",className:I(r==null?void 0:r.title,(At=t==null?void 0:t.classNames)==null?void 0:At.title)},typeof t.title=="function"?t.title():t.title),t.description?o.default.createElement("div",{"data-description":"",className:I(st,qt,r==null?void 0:r.description,(Lt=t==null?void 0:t.classNames)==null?void 0:Lt.description)},typeof t.description=="function"?t.description():t.description):null),(0,o.isValidElement)(t.cancel)?t.cancel:t.cancel&&et(t.cancel)?o.default.createElement("button",{"data-button":!0,"data-cancel":!0,style:t.cancelButtonStyle||gt,onClick:n=>{var m,d;et(t.cancel)&&V&&((d=(m=t.cancel).onClick)==null||d.call(m,n),$())},className:I(r==null?void 0:r.cancelButton,(zt=t==null?void 0:t.classNames)==null?void 0:zt.cancelButton)},t.cancel.label):null,(0,o.isValidElement)(t.action)?t.action:t.action&&et(t.action)?o.default.createElement("button",{"data-button":!0,"data-action":!0,style:t.actionButtonStyle||c,onClick:n=>{var m,d;et(t.action)&&((d=(m=t.action).onClick)==null||d.call(m,n),!n.defaultPrevented&&$())},className:I(r==null?void 0:r.actionButton,(jt=t==null?void 0:t.classNames)==null?void 0:jt.actionButton)},t.action.label):null))};function Xt(){if(typeof window=="undefined"||typeof document=="undefined")return"ltr";let s=document.documentElement.getAttribute("dir");return s==="auto"||!s?window.getComputedStyle(document.documentElement).direction:s}function Ce(s,e){let t={};return[s,e].forEach((a,l)=>{let f=l===1,w=f?"--mobile-offset":"--offset",R=f?Se:Te;function g(i){["top","right","bottom","left"].forEach(D=>{t[`${w}-${D}`]=typeof i=="number"?`${i}px`:i})}typeof a=="number"||typeof a=="string"?g(a):typeof a=="object"?["top","right","bottom","left"].forEach(i=>{a[i]===void 0?t[`${w}-${i}`]=R:t[`${w}-${i}`]=typeof a[i]=="number"?`${a[i]}px`:a[i]}):g(R)}),t}function ke(){let[s,e]=o.default.useState([]);return o.default.useEffect(()=>v.subscribe(t=>{if(t.dismiss){setTimeout(()=>{pt.default.flushSync(()=>{e(a=>a.filter(l=>l.id!==t.id))})});return}setTimeout(()=>{pt.default.flushSync(()=>{e(a=>{let l=a.findIndex(f=>f.id===t.id);return l!==-1?[...a.slice(0,l),{...a[l],...t},...a.slice(l+1)]:[t,...a]})})})}),[]),{toasts:s}}var Ie=(0,o.forwardRef)(function(e,t){let{invert:a,position:l="bottom-right",hotkey:f=["altKey","KeyT"],expand:w,closeButton:R,className:g,offset:i,mobileOffset:D,theme:T="light",richColors:F,duration:ot,style:mt,visibleToasts:gt=ve,toastOptions:c,dir:at=Xt(),gap:st=Ee,loadingIcon:K,icons:rt,containerAriaLabel:ht="Notifications",pauseWhenPageIsHidden:nt}=e,[B,r]=o.default.useState([]),P=o.default.useMemo(()=>Array.from(new Set([l].concat(B.filter(u=>u.position).map(u=>u.position)))),[B,l]),[it,lt]=o.default.useState([]),[j,M]=o.default.useState(!1),[ct,X]=o.default.useState(!1),[W,H]=o.default.useState(T!=="system"?T:typeof window!="undefined"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),A=o.default.useRef(null),bt=f.join("+").replace(/Key/g,"").replace(/Digit/g,""),L=o.default.useRef(null),Y=o.default.useRef(!1),dt=o.default.useCallback(u=>{r(h=>{var y;return(y=h.find(E=>E.id===u.id))!=null&&y.delete||v.dismiss(u.id),h.filter(({id:E})=>E!==u.id)})},[]);return o.default.useEffect(()=>v.subscribe(u=>{if(u.dismiss){r(h=>h.map(y=>y.id===u.id?{...y,delete:!0}:y));return}setTimeout(()=>{pt.default.flushSync(()=>{r(h=>{let y=h.findIndex(E=>E.id===u.id);return y!==-1?[...h.slice(0,y),{...h[y],...u},...h.slice(y+1)]:[u,...h]})})})}),[]),o.default.useEffect(()=>{if(T!=="system"){H(T);return}if(T==="system"&&(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?H("dark"):H("light")),typeof window=="undefined")return;let u=window.matchMedia("(prefers-color-scheme: dark)");try{u.addEventListener("change",({matches:h})=>{H(h?"dark":"light")})}catch(h){u.addListener(({matches:y})=>{try{H(y?"dark":"light")}catch(E){console.error(E)}})}},[T]),o.default.useEffect(()=>{B.length<=1&&M(!1)},[B]),o.default.useEffect(()=>{let u=h=>{var E,z;f.every(p=>h[p]||h.code===p)&&(M(!0),(E=A.current)==null||E.focus()),h.code==="Escape"&&(document.activeElement===A.current||(z=A.current)!=null&&z.contains(document.activeElement))&&M(!1)};return document.addEventListener("keydown",u),()=>document.removeEventListener("keydown",u)},[f]),o.default.useEffect(()=>{if(A.current)return()=>{L.current&&(L.current.focus({preventScroll:!0}),L.current=null,Y.current=!1)}},[A.current]),o.default.createElement("section",{ref:t,"aria-label":`${ht} ${bt}`,tabIndex:-1,"aria-live":"polite","aria-relevant":"additions text","aria-atomic":"false",suppressHydrationWarning:!0},P.map((u,h)=>{var z;let[y,E]=u.split("-");return B.length?o.default.createElement("ol",{key:u,dir:at==="auto"?Xt():at,tabIndex:-1,ref:A,className:g,"data-sonner-toaster":!0,"data-theme":W,"data-y-position":y,"data-lifted":j&&B.length>1&&!w,"data-x-position":E,style:{"--front-toast-height":`${((z=it[0])==null?void 0:z.height)||0}px`,"--width":`${Re}px`,"--gap":`${st}px`,...mt,...Ce(i,D)},onBlur:p=>{Y.current&&!p.currentTarget.contains(p.relatedTarget)&&(Y.current=!1,L.current&&(L.current.focus({preventScroll:!0}),L.current=null))},onFocus:p=>{p.target instanceof HTMLElement&&p.target.dataset.dismissible==="false"||Y.current||(Y.current=!0,L.current=p.relatedTarget)},onMouseEnter:()=>M(!0),onMouseMove:()=>M(!0),onMouseLeave:()=>{ct||M(!1)},onPointerDown:p=>{p.target instanceof HTMLElement&&p.target.dataset.dismissible==="false"||X(!0)},onPointerUp:()=>X(!1)},B.filter(p=>!p.position&&h===0||p.position===u).map((p,_)=>{var O,J;return o.default.createElement(Be,{key:p.id,icons:rt,index:_,toast:p,defaultRichColors:F,duration:(O=c==null?void 0:c.duration)!=null?O:ot,className:c==null?void 0:c.className,descriptionClassName:c==null?void 0:c.descriptionClassName,invert:a,visibleToasts:gt,closeButton:(J=c==null?void 0:c.closeButton)!=null?J:R,interacting:ct,position:u,style:c==null?void 0:c.style,unstyled:c==null?void 0:c.unstyled,classNames:c==null?void 0:c.classNames,cancelButtonStyle:c==null?void 0:c.cancelButtonStyle,actionButtonStyle:c==null?void 0:c.actionButtonStyle,removeToast:dt,toasts:B.filter(C=>C.position==p.position),heights:it.filter(C=>C.position==p.position),setHeights:lt,expandByDefault:w,gap:st,loadingIcon:K,expanded:j,pauseWhenPageIsHidden:nt,swipeDirections:e.swipeDirections})})):null}))});0&&(module.exports={Toaster,toast,useSonner});
