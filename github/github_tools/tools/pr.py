...
gh api \
  ...
  /repos/$repo/pulls/$number/comments \
   -f "body=$FULL_COMMENT" -f "commit_id=$COMMIT_ID" -f "path=$file_path" -f "line=$line_number" -f "side=RIGHT"
...
for tool in [pr_create, pr_list, pr_view, pr_merge, pr_close, pr_comment, pr_file_comment, pr_review, pr_diff, pr_ready, pr_checks, pr_files, pr_assign, pr_add_reviewer]:
    tool_registry.register("github", tool)

# Export all PR tools
__all__ = ['pr_create', 'pr_list', 'pr_view', 'pr_merge', 'pr_close', 'pr_comment', 'pr_file_comment', 'pr_review', 'pr_diff', 'pr_ready', 'pr_checks', 'pr_files', 'pr_assign', 'pr_add_reviewer']
