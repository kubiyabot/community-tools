...
def generate_comment(variables: dict) -> str:
    ...
    try:
        ...
        context = {
            ...
            'run_details': '{"processed_at": "2024-12-29 05:47:39", "status": "completed", "conclusion": "failure", "id": "12532922165", "actor": "Kubiya-Testing", "number": "3", "repo": "Kubiya-Testing/KubiyaTesting"}',
            'number': '3',
