...
terraform_init = _create_terraform_tool(
    "init",
...
terraform_plan = _create_terraform_tool(
    "plan",
...
terraform_apply = _create_terraform_tool(
    "apply",
...
terraform_destroy = _create_terraform_tool(
    "destroy",
...
terraform_output = _create_terraform_tool(
    "output",
...
terraform_show = _create_terraform_tool(
    "show",
...
terraform_validate = _create_terraform_tool(
    "validate",
...
terraform_workspace_list = _create_terraform_tool(
    "workspace_list",
...
terraform_workspace_select = _create_terraform_tool(
    "workspace_select",
...
terraform_state_list = _create_terraform_tool(
    "state_list",
...
terraform_state_show = _create_terraform_tool(
    "state_show",
