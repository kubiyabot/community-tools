...
from scripts import search_access_requests_handler as search_access_requests_script
...
search_access_requests_tool = JustInTimeAccessTool(
    ...
    with_files=[
        FileSpec(
            ...
            content=inspect.getsource(search_access_requests_script).encode('utf-8'),
        ),
    ],
    with_volumes=[
        Volume(
