...
def notify_user(request_id, status, user_email, approver_email, ttl: str = ""):
    ...
    message = {
        ...
        "blocks": [
            ...
            {"type": "section", "text": {"type": "mrkdwn", "text": "*⚙️ Parameters:*"}},
            {
                "type": "section",
                "text": {
                    "type": "mrkdwn",
        ...
        [
            {"type": "divider"},
            {
                ...
                "elements": [
                    ...
                    {"type": "mrkdwn", "text": f"👤 Approved by: {approver_email}"},
                ],
            },
        ]
    )
