...
def create_sprint(board_id: int, name: str, goal: str = None, start_date: str = None, end_date: str = None) -> dict:
    ...
    create_url = f"{ATLASSIAN_JIRA_API_URL}/{cloud_id}/rest/agile/1.0/sprint"
...
def get_sprint_status(sprint_id: int) -> dict:
    ...
    cloud_id = get_jira_cloud_id()
    sprint_url = f"{ATLASSIAN_JIRA_API_URL}/{cloud_id}/rest/agile/1.0/sprint/{sprint_id}"
...
def update_sprint_state(sprint_id: int, state: str) -> dict:
    ...
    cloud_id = get_jira_cloud_id()
    state_url = f"{ATLASSIAN_JIRA_API_URL}/{cloud_id}/rest/agile/1.0/sprint/{sprint_id}"
...
def move_issues_to_sprint(sprint_id: int, issue_keys: List[str]) -> bool:
    ...
    cloud_id = get_jira_cloud_id()
    move_url = f"{ATLASSIAN_JIRA_API_URL}/{cloud_id}/rest/agile/1.0/sprint/{sprint_id}/issue"
...
def get_sprint_issues(sprint_id: int) -> List[dict]:
    ...
    cloud_id = get_jira_cloud_id()
    issues_url = f"{ATLASSIAN_JIRA_API_URL}/{cloud_id}/rest/agile/1.0/sprint/{sprint_id}/issue"
