...
class GitLabTool(Tool):
    """Base class for all GitLab tools."""
    
    name: str
    description: str
    content: str = ""
    args: List[Arg] = []
    image: str = "gitlab/gitlab-ce:latest"
    icon_url: str = GITLAB_ICON_URL
    type: str = "docker"
    mermaid: str = DEFAULT_MERMAID
    
    def __init__(self, name, description, content, args=None, image="gitlab/gitlab-ce:latest"):
        super().__init__(
            name=name,
